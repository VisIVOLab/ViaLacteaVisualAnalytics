...
enum PlottingHint {
    ...
    phFastPolylines = 0x001 ///< <tt>0x001</tt> Graph/Curve lines are drawn with a faster method.
                            ...
                            ///<                especially of the line segment joins. (Only relevant
                            ///<                for solid line pens.)
    ,
    phForceRepaint =
            0x002 ///< <tt>0x002</tt> causes an immediate repaint() instead of a soft update() when
                  ...
                  ///<                This is set by default to prevent the plot from freezing on
                  ///<                fast consecutive replots (e.g. user drags ranges with mouse).
    ,
...
enum Interaction {
    ...
    ,
    iMultiSelect =
            0x004 ///< <tt>0x004</tt> The user can select multiple objects by holding the modifier
...
protected:
    ...
    void getTraverseCornerPoints(int prevRegion, int currentRegion, double rectLeft, double rectTop,
