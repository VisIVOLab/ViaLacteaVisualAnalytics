...
private:
    ...
    static const unsigned long long int
            MAX_NUMBER_TO_SKIP; //! maximum number to skip in a single skip
    static const unsigned long long int
            MAX_NUMBER_ROW_REQUEST; //! maximum number of rows for each request
    static const unsigned long long int
            MAX_NUMBER_OF_BYTES; //! maximum number of bytes for each request
...
public:
    ...
    VSTableDesktop(std::string locator, std::string name = "", std::string description = "",
                   bool statistic = true);
    int getColumnString(unsigned int *colList, unsigned int nOfCol, unsigned long long int fromRow,
                        unsigned long long int toRow, std::string **matrix);
    ...
    void
    setLocator(std::string locator); //! set the table path (used in writeheader and readheader)
    ...
    void setCellNumber(unsigned int xCellNumber, unsigned int yCellNumber,
    ...
    int putColumn(unsigned int *colList, unsigned int nOfCol, unsigned long long int fromRow,
                  unsigned long long int toRow, float **fArray); //!  put data (see getColumn)
    int putColumnList(unsigned int *colList, unsigned int nOfCol, unsigned long long int *list,
                      unsigned long long int nOfEle,
                      float **fArray); //! put data (see getColumnList)
    ...
    int getColumnStringToFloat(unsigned int *colList, unsigned int nOfCol,
