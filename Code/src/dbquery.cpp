...
dbquery::dbquery(QWidget *parent) : QDialog(parent), ui(new Ui::dbquery)
{
    ui->setupUi(this);
    n_surveys = 10; //+2
    n_species = 11; //+1
        ...
        if (url.contains("vlkb_search")) {
            ...
            if (string.compare("NULL") != 0) {
                ...
                QMessageBox::critical(NULL, QObject::tr("Error"),
                                      QObject::tr("Datacube inexistent - Try again"));
            }
        }
...
void dbquery::addDatacubesToUI(QList<QMap<QString, QString>> &datacubes)
{
    ...
    while (!datacubes.isEmpty()) {
        ...
        if (!datacube["Survey"].contains("HI-Gal")) {
            ...
            p_button->setGeometry(QRect(QPoint(100, 100), QSize(200, 50)));
