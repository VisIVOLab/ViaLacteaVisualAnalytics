...
private:
    ...
    void addDatacubeToMap(QXmlStreamReader &xml, QMap<QString, QString> &map) const;

    void addDatacubesToUI(QList<QMap<QString, QString>> &datacubes);

    QString extractPublisherDID_fits(QList<QMap<QString, QString>> &datacubes,
                                     QMap<QString, QString> &element);
    QString extractPublisherDID(QList<QMap<QString, QString>> &datacubes,
                                QMap<QString, QString> &element);
