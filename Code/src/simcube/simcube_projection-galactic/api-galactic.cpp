...
void simcube::collapsed_to_galactic(std::string fitsname_image,
                                    double dist_parsec,
  ...
  cdelt_gal_deg[0] = r2d * simg.cdelt_vals[0] / dist_parsec;
  cdelt_gal_deg[1] = r2d * simg.cdelt_vals[1] / dist_parsec;
