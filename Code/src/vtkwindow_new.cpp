...
void vtkwindow_new::initializeMenuConnections()
{
    ...
    connect(visivoMenu, &VisIVOMenu::addFitsFileTriggered, this, &vtkwindow_new::addLocalFileTriggered);
    connect(visivoMenu, &VisIVOMenu::localCompactSourcesTriggered, this, &vtkwindow_new::addLocalSources);
    connect(visivoMenu, &VisIVOMenu::jsonCompactSourcesTriggered, this, [=]()
            {
    ...
    connect(visivoMenu, &VisIVOMenu::ds9CompactSourcesTriggered, this, &vtkwindow_new::loadDS9RegionFile);
    connect(visivoMenu, &VisIVOMenu::remoteCompactSourcesTriggered, this, &vtkwindow_new::setSkyRegionSelectorInteractorStyle);
    connect(visivoMenu, &VisIVOMenu::compactSources3DTriggered, this, &vtkwindow_new::on_tdRectPushButton_clicked);
    ...
    connect(visivoMenu, &VisIVOMenu::souceFindersTriggered, this, &vtkwindow_new::on_actionCAESAR_triggered);
